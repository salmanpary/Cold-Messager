...
const AboutUs = () => {
  return (
    <>
      ...
      <div className="mt-28 p-10">
        ...
        <div className="pb-6">
          ...
          brings with him a love for all things product and marketing, spending
          his time building campus communities and organizing events.
          <a
          ...
          applications for the past year, with various internships and was a
          part of a team building a chrome extension previously.
        </div>
    ...
    <div>
        ...
        <div className="text-[#ffcc4b] font-bold text-3xl pt-5 pb-5">The Product</div>
        <div>
          Cold Messager is a chrome extension that helps you optimize your cold
          outreach campaigns on Linkedin.
          Cold Messager helps you hook your prospects with personalized messages.
        </div>
