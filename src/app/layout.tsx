    ...
    '@graph': [
      {
        ...
        'thumbnailUrl': 'https://octopuscrm.io/wp-content/uploads/2023/08/Thumbnail-Best-Ways-to-Cold-Message-on-LinkedIn.webp',
        'articleSection': ['Blog', 'LinkedIn Hacks', 'Octopus CRM', 'Sales & Marketing'],
        'inLanguage': 'en-US',
        'potentialAction': [
          {
            '@type': 'CommentAction',
            'name': 'Comment',
            'target': ['https://octopuscrm.io/blog/linkedin-cold-message-examples/#respond'],
          },
        ],
      },
      {
        ...
        'potentialAction': [
          {
            '@type': 'ReadAction',
            'target': ['https://octopuscrm.io/blog/linkedin-cold-message-examples/'],
          },
        ],
      },
      {
        ...
        'contentUrl': 'https://octopuscrm.io/wp-content/uploads/2023/08/Thumbnail-Best-Ways-to-Cold-Message-on-LinkedIn.webp',
      ...
      },
      {
        ...
        'name': 'Octopus CRM',
        'description': 'The all-in-one LinkedIn automation software for marketers, owners and recruiters',
        'publisher': {
          '@id': 'https://octopuscrm.io/#organization',
        },
        'potentialAction': [
          {
            ...
            'target': {
              '@type': 'EntryPoint',
              'urlTemplate': 'https://octopuscrm.io/?s={search_term_string}',
            },
      ...
      },
      {
        ...
        'logo': {
          ...
          'contentUrl': 'https://octopuscrm.io/wp-content/uploads/2019/07/footer-logo.png',
          'width': 240,
          'height': 43,
          'caption': 'Octopus CRM',
        },
